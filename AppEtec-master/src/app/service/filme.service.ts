...
export class FilmeService {
  ...
  public buscarFavoritos(): Observable<IFilmesFavoritos>{
    ...
    const configApi = {
      'X-Parse-Application-Id': 'HGNUA7G7dnotjNzTCiAj3ZVmQVuBnJz66Z32CrKf',
      'X-Parse-REST-API-Key': 'u864PbdggQ4d60oHd7eld3YPIUHDcZ2CNHgVpgH7'
    };
  ...
  public addFavoritos(): Observable<IFilmesFavoritos>{
    const url = 'https://parseapi.back4app.com/classes/Filme';
    ...
    return this.http.post<IFilmesFavoritos>(url,{headers}).pipe(
      map(retorno => retorno),
      catchError(erro => this.exibirErro2(erro))
    );
  }
